...
module.exports = [
    ...
    {
        "file": "plugins/cordova-plugin-device-mv/www/device.js",
        "id": "cordova-plugin-device-mv.device",
        "pluginId": "cordova-plugin-device-mv",
        "clobbers": [
            "device"
        ]
    },
    {
        "file": "plugins/cordova-plugin-device-mv/src/browser/DeviceProxy.js",
        "id": "cordova-plugin-device-mv.DeviceProxy",
        "pluginId": "cordova-plugin-device-mv",
        "runs": true
    }
];
...
// TOP OF METADATA
{
    ...
    "cordova-plugin-device-mv": "2.0.3"
}
// BOTTOM OF METADATA
});